...
class Advertisement(pydantic.BaseModel):
    id: int
    heading: str
    description: str
    price: int
...
class PaginatedAdvertisementsRequest(PaginatedRequestBase):
    name: Optional[str] = None
    important: Optional[bool] = None
    done: Optional[bool] = None
    user_id: Optional[int] = None
...
class PaginatedAdvertisementsResponse(PaginatedResponseBase):
    advs: List[Advertisement]


class DeleteAdvertisementResponse(BaseDeleteResponse):
    pass
